...
from app.crud.subscr import get_subscr_compare_by_hndset, get_subscr_compare_by_hndset2

router = APIRouter()


@router.get("/compare2", response_model=List[schemas.SubscrCompareOutput])
async def get_subscr_by_hndset2(code:str=None, group:str="", start_date: str = "20220710", db: SessionLocal = Depends(get_db)):
