...
CREATE TABLE SUM_VOC_TXN_RTIME (
  BASE_DATE int(11) DEFAULT NULL,
  SR_TT_RCP_NO varchar(30) DEFAULT NULL,
  SVC_CONT_SORC_ID varchar(50) DEFAULT NULL,
  VOC_WJT_PRMR_NM varchar(10) DEFAULT NULL,
  VOC_WJT_SCND_NM varchar(20) DEFAULT NULL,
  VOC_WJT_TERT_NM varchar(20) DEFAULT NULL,
  VOC_WJT_QRTC_NM varchar(50) DEFAULT NULL,
  VOC_TYPE_SORC_NM varchar(20) DEFAULT NULL,
  HNDSET_PET_NM varchar(50) DEFAULT NULL,
  MF_CD_NM varchar(50) DEFAULT NULL,
  BSS_ORG_NM varchar(20) DEFAULT NULL,
  EMP_BIZR_NM varchar(20) DEFAULT NULL,
  BIZ_HQ_NM varchar(50) DEFAULT NULL,
  LEG_SIDO_NM varchar(100) DEFAULT NULL,
  LEG_GUN_GU_NM varchar(100) DEFAULT NULL,
  LEG_DONG_NM varchar(100) DEFAULT NULL,
  EQUIP_NM varchar(100) DEFAULT NULL,
  EQUIP_NM_RT varchar(100) DEFAULT NULL,
  ANALS_3_PROD_LEVEL_NM varchar(50) DEFAULT NULL,
  SIDO_NM varchar(100) DEFAULT NULL,
  GUN_GU_NM varchar(100) DEFAULT NULL,
  EUP_MYUN_DONG_NM varchar(100) DEFAULT NULL,
  TROBL_BAS_ADR varchar(150) DEFAULT NULL,
  TROBL_DTL_ADR varchar(150) DEFAULT NULL,
  ADM_SIDO_NM varchar(100) DEFAULT NULL,
  ADM_GUN_GU_NM varchar(100) DEFAULT NULL,
  ADM_DONG_NM varchar(100) DEFAULT NULL,
  SA_5G_SUPRT_DIV_NM varchar(50) DEFAULT NULL,
  LATIT_VAL_RT varchar(100) DEFAULT NULL,
  LNGIT_VAL_RT varchar(100) DEFAULT NULL,
  LATIT_VAL varchar(100) DEFAULT NULL,
  LNGIT_VAL varchar(100) DEFAULT NULL,
  VOC_RCP_TXN longtext,
  SR_TT_RCP_NO_CNT varchar(100) DEFAULT NULL,
  MKNG_CMPN_NM varchar(50) DEFAULT NULL,
  OPER_TEAM_NM varchar(50) DEFAULT NULL,
  EQUIP_CD varchar(30) DEFAULT NULL,
  AREA_HQ_NM varchar(50) DEFAULT NULL,
  AREA_CENTER_NM varchar(50) DEFAULT NULL,
  AREA_TEAM_NM varchar(50) DEFAULT NULL,
  AREA_JO_NM varchar(50) DEFAULT NULL
