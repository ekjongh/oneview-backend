...
def get_worst10_offloading_jo_by_group_date(db: Session, group: str, start_date: str=None, end_date: str=None, limit: int=10):
    ...
    g5_off_ratio = func.coalesce(g5_off_ratio, 0.0).label("오프로딩율_5G")
    ...
    entities = [
        ...
        models.Offloading_Bts.equip_cd.label("기지국ID"),
        # juso,
    ...
    stmt_rk = select([
        func.rank().over(order_by=stmt.c.오프로딩율_5G.asc()).label("RANK"),
        *stmt.c
    ])
...
def get_worst10_offloading_hndset_by_group_date(db: Session, group: str, start_date: str = None, end_date: str = None,
    ...
    entities = [
        models.Offloading_Hndset.hndset_pet_nm.label("단말기명"),
    ]
    entities_groupby = [
        g5_off_ratio
        # sum_3g_data,
