...
async def get_offloading_trend_by_group_date2(db: AsyncSession, code:str, group: str, start_date: str=None, end_date: str=None):
    ...
    if code == "제조사별":
        ...
        stmt = stmt.where(models.Offloading.biz_hq_nm.in_(stmt_where))
    elif code == "센터별":
        ...
        stmt = stmt.where(models.Offloading.biz_hq_nm.in_(txt_l))
    elif code == "팀별":
        ...
        if "지하철엔지니어링부" in txt_l:
            ...
            stmt = stmt.where(models.Offloading.area_jo_nm.in_(stmt_where))
...
async def get_offloading_trend_item_by_group_date(db: AsyncSession, code: str, group: str, start_date: str = None,
    ...
    # 선택 조건
    if code == "제조사별":
        stmt_sel_nm = models.Offloading.mkng_cmpn_nm
    elif code == "본부별":
        ...
        stmt_sel_nm = models.Offloading.biz_hq_nm
    elif code == "센터별":
        ...
        if "지하철엔지니어링부" in where_ins:
            stmt_sel_nm = models.Offloading.oper_team_nm
        else:
            ...
            stmt_sel_nm = models.Offloading.area_jo_nm
        ...
        stmt_sel_nm = models.Offloading.eup_myun_dong_nm
    elif code == "시군구별":
    ...
    if code_tbl_nm == None:  # code table 미사용시
        ...
        stmt = select(
            ...
            and_(*stmt_where_and)
        ).group_by(models.Offloading.base_date, stmt_sel_nm)
